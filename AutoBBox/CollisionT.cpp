...
int CollisionT::index = 0;                      // �ndice do vetor
...
void CollisionT::Init()
{
    ...
    // carrega folha de sprites e cria anima��o
    ...
    // guarda posi��o inicial dos objetos
    pos[0] = { 226, 180 };
    pos[1] = { 426, 180 };
    pos[2] = { 576, 180 };
    pos[3] = { 726, 180 };
...
void CollisionT::Update()
{
    ...
    // altera escala e rota��o do objeto
    if (window->KeyDown('S'))
    ...
    // atualiza anima��o da caixa de sele��o
    select->NextFrame();
...
void CollisionT::Draw()
{
    ...
    font->Draw(pos[3].x + 2, 260, "Avi�o", textColor);
    ...
    case PLANE:   bold->Draw(window->CenterX() + 0, 49, "Avi�o", boldColor);   break;
    ...
    // desenha mapeamento de teclas e suas fun��es
    float posY = window->Height() - 6.0f;
    font->Draw(window->CenterX() - 348.0f, posY, "Tab      Sele��o", textColor);
    font->Draw(window->CenterX() - 235.0f, posY, "B      Bounding Box", textColor);
    font->Draw(window->CenterX() - 103.0f, posY, "R      Restaurar", textColor);
    font->Draw(window->CenterX() + 54.0f, posY, "Transla��o      Setas", textColor);
    font->Draw(window->CenterX() + 191.0f, posY, "Escala      A | S", textColor);
    font->Draw(window->CenterX() + 301.0f, posY, "Rota��o      Z | X", textColor);
    ...
    //desenha caixa de sele��o animada
                     ...
                     _In_ LPSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    engine->window->Title("Teste de Colis�o");
